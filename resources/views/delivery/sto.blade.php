        ...
        <div class="main" style="margin-top:15px;">           
            ...
            <div class="form-group col-sm-7">
              <div class="form-group pull-right">
                <div class="col-sm-10">
                    @if($sto)
               <a href="/deliveries/add" class="button"> <button type="button" class="btn btn-success"><i class="fa fa-plus-circle"></i><span style="font-size:11px;"> Create Delivery</span></button></a>
                  @endif
            </div>
            </div>
           </div> 
        ...
        <div class="modal fade" id="stogrid" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    <div class="modal-header ">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="basicvalCode"><strong>Deliveries</strong> : <span class="delivery_no"></span></h4>
                    </div>
                    <div class="modal-body">
                        <div id="del_grid"></div>
...
/*
  ...
  //  "/delivery/getDeliveries/"+id;
    ...
    $.get(url,function(response){
        ...
        var clms=[
                { text: 'Document No', datafield: 'document_no', filtertype: 'input', width:'15%'},
                ...
                { text: 'Storage Location', datafield: 'StorLoc', filtertype: 'input', width:'14%'},
                { text: 'Status', datafield: 'status', filtertype: 'input', width:'15%'},
        ...
        var source_del =
          {
            ...
            var dataAdapter = new $.jqx.dataAdapter(source_del);
                ...
                { text: 'Status', datafield: 'status', filtertype: 'input', width:'12.5%'},
...
//validator
    ...
    $.get(url,function(response){
        ...
        var clms=[
                ...
                { text: 'Status', datafield: 'remarks', filtertype: 'input', width:'30%'},
